export const BUSSY_TOOLS = [
  {
    ...
    function: {
      name: "calculate_loan",
      description: "Kredit bo‘yicha oylik annuitet to‘lov, jami to‘lov va jami foizni hisoblash",
      parameters: {
        type: "object",
        properties: {
          amount: { type: "number", description: "Kredit summasi (so‘mda)" },
          annual_rate: { type: "number", description: "Yillik foiz stavkasi (masalan, 24)" },
          months: { type: "number", description: "Kredit muddati (oylarda, masalan 24)" },
        },
  ...
  },
  {
    ...
    function: {
      ...
      description: "Oylik tushum, o‘zgarmas va o‘zgaruvchan xarajatlar asosida yalpi va sof foydani hisoblash",
      parameters: {
        type: "object",
        properties: {
          revenue: { type: "number", description: "Oylik kutilayotgan tushum (so‘mda)" },
          fixed_cost: { type: "number", description: "Oylik o‘zgarmas xarajatlar (ijara, maosh)" },
          variable_cost: { type: "number", description: "Oylik o‘zgaruvchan xarajatlar (xom-ashyo)" },
          tax: { type: "number", description: "Soliq stavkasi foizda (masalan, 4)" },
        },
  ...
  },
  {
    ...
    function: {
      ...
      description: "Oylik sof pul oqimi (cash-flow) va likvidlik holatini hisoblash",
      parameters: {
        type: "object",
        properties: {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          revenue: { type: "number", description: "Oylik jami tushum (so‘mda)" },
          expenses: { type: "number", description: "Oylik jami xarajatlar (so‘mda)" },
          rate: {
            type: "number",
            description: "Ixtiyoriy: soliq stavkasi foizda (aylanma soliq uchun, masalan 4)",
          },
          vatable_expenses: {
            type: "number",
            description:
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          business_type: { type: "string", description: "Biznes turi (masalan, fast food, novvoyxona, kofe)" },
          location: { type: "string", description: "Shahar yoki hudud (masalan, Urganch, Toshkent)" },
          initial_capital: { type: "number", description: "Boshlang‘ich shaxsiy kapital" },
          monthly_expenses: { type: "number", description: "Taxminiy oylik xarajatlar" },
          expected_revenue: { type: "number", description: "Kutilayotgan oylik tushum" },
          employees: { type: "number", description: "Xodimlar soni" },
          target_customer: { type: "string", description: "Maqsadli mijozlar" },
        },
        required: ["business_type", "location", "initial_capital", "monthly_expenses", "expected_revenue"],
      },
    },
  },
  {
    ...
    function: {
      ...
      description: "Biznes g‘oyasini boshlang‘ich kapital, xarajatlar, risklar va tekshirish gipotezalari bo‘yicha tahlil qilish",
      parameters: {
        type: "object",
        properties: {
          business_idea: { type: "string", description: "Biznes g‘oyasi tavsifi" },
  ...
  },
  {
    ...
    function: {
      ...
      description: "Biznesning kredit to‘lovini ko‘tara olish qobiliyatini (Debt Burden) tahlil qilish",
      parameters: {
        type: "object",
        properties: {
        ...
        required: ["revenue", "expenses", "loan_amount", "annual_rate", "months"],
      },
    },
  },
];
